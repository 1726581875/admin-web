<template>
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select v-model="selectValue" placeholder="查询条件" class="handle-select mr10">
                                            <el-option key="0" label="主键id" value="id"></el-option>
                        <el-option key="1" label="课程名称" value="name"></el-option>
                        <el-option key="2" label="讲师id" value="teacherId"></el-option>
                        <el-option key="3" label="课程概述" value="summary"></el-option>
                        <el-option key="4" label="时长" value="duration"></el-option>
                        <el-option key="5" label="封面图片" value="image"></el-option>
                        <el-option key="6" label="学习人数" value="learningNum"></el-option>
                        <el-option key="7" label="评论数" value="commentNum"></el-option>
                        <el-option key="8" label="状态" value="status"></el-option>
                        <el-option key="9" label="创建时间" value="createTime"></el-option>
                        <el-option key="10" label="修改时间" value="updateTime"></el-option>
                </el-select>
                <!--  查找输入框 -->
                <el-input
                        v-model="inputVale"
        ...
        <el-dialog :title="dialogTitle" :visible.sync="editVisible" width="40%">
            <el-form ref="course" :model="course" label-width="70px">
                        <el-form-item label="课程名称">
                            <el-input v-model="course.name"></el-input>
                        </el-form-item>
                        <el-form-item label="讲师id">
                            <el-input v-model="course.teacherId"></el-input>
                        </el-form-item>
                        <el-form-item label="课程概述">
                            <el-input v-model="course.summary"></el-input>
                        </el-form-item>
                        <el-form-item label="时长">
                            <el-input v-model="course.duration"></el-input>
                        </el-form-item>
                        <el-form-item label="封面图片">
                            <el-input v-model="course.image"></el-input>
                        </el-form-item>
                        <el-form-item label="学习人数">
                            <el-input v-model="course.learningNum"></el-input>
                        </el-form-item>
                        <el-form-item label="评论数">
                            <el-input v-model="course.commentNum"></el-input>
                        </el-form-item>
                        <el-form-item label="状态">
                            <el-input v-model="course.status"></el-input>
                        </el-form-item>
                        <el-form-item label="创建时间">
                            <el-input v-model="course.createTime"></el-input>
                        </el-form-item>
                        <el-form-item label="修改时间">
                            <el-input v-model="course.updateTime"></el-input>
                        </el-form-item>
            </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit(index, row) {
        ...
        let newCourse = JSON.parse(JSON.stringify(row));
      ...
      save() {
        ...
        //3、发请求
        this.$axios.post('http://localhost:9001/admin/courses/course', this.course)
          .then(res => {
            if (res.data.success) {
